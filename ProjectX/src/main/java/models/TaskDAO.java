...
public class TaskDAO {
    ...
    public void updateTask(TaskBean task, Map<String, Object> attributes) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Something went wrong during updating task " + task.getIdTask(), e);
        } finally {
    ...
    public void removeTasksWhenOutsourcing(int idStage) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during deleting work tasks for stage " + idStage, e);
            } finally {
                DbConnection.disconnect(currentConn, statement);
            }
        }
