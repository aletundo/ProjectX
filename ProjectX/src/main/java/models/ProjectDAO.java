...
public class ProjectDAO {
    ...
    public void updateProject(ProjectBean project, Map<String, Object> attributes) {
        ...
        try {
            ...
            LOGGER.log(Level.SEVERE, "Something went wrong during updating project " + project.getIdProject(), e);
        } finally {
    ...
    public int getProjectManagerId(int idProject) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during getting project manager of project " + idProject,
                        e);
            } finally {
    ...
    public ProjectBean getProjectInfo(int idProject) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during getting details of project " + idProject, e);
            } finally {
                DbConnection.disconnect(currentConn, rs, statement);
            }
        }
    ...
    public boolean checkNameAlreadyExist(String name) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during checking if " + name + " project already exist",
                        e);
            } finally {
                DbConnection.disconnect(currentConn, rs, statement);
            }
    ...
    public int addProject(ProjectBean project) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during creation of project " + project.toString(), e);
            } finally {
                DbConnection.disconnect(currentConn, rs, statement);
            }
        }
    ...
    public List<ProjectBean> getUserProjects(UserBean user) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE,
                        "Something went wrong during getting all project which " + user.toString() + " is involved in",
                        e);
            } finally {
                DbConnection.disconnect(currentConn, rs, statement);
            }
    ...
    public List<ProjectBean> searchProjects(String subjectArea) {
        ...
        if (currentConn != null) {
            ...
            try {
                ...
                LOGGER.log(Level.SEVERE, "Something went wrong during getting project related to " + subjectArea, e);
            } finally {
                DbConnection.disconnect(currentConn, rs, statement);
            }
        }
